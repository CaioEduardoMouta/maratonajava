...
public class ListaMembros {
    ...
    /*
        synchronized – mecanismo que permite ao programador controlar
        threads, para que as mesmas possam compartilhar a mesma base 
        de dados sem causar conflitos;
    */
    ...
    public void fecharLista() {
        System.out.println("Notificando todas as threads e fechando as lista");
        aberta = false;
        synchronized (this.emails) {
            this.emails.notifyAll();
        }
