...
//            Thread.yield() pelo o que eu entendi ele trava o andamento do programa;
/*
yield() – Deixa a thread em execução temporariamente inativa e, quando possível,
 promove outra thread de mesma prioridade ou maior;
*/
            try {
                Thread.sleep(100);
...
//        ThreadExemplo t4 = new ThreadExemplo('D');
        ...
        t1.start();
        t1.join();// Significado da palavra join é juntar
        t2.start();
