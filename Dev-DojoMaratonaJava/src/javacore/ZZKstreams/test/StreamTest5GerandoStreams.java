...
public class StreamTest5GerandoStreams {
    public static void main(String[] args) {
        ...
        Stream<String> bulletCoffee = Stream.of("Hot Coffee","Desincoffee","SuperCoffee");
        System.out.println();
        bulletCoffee.map(String::toUpperCase)
                .forEach(s -> System.out.print(s+ " "));
        ...
        //rangeClosed vai até o último número
        //range vai até o penultimo número
    }
}
